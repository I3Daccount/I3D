...
public:	
	...
	//
	std::map<void*, std::pair<cgv::media::illum::light_source, light_source_status> >* ref_light_sources() { return &light_sources; }
	//
	void* ref_default_light_source_handles() { return &default_light_source_handles; }
...
protected:
	...
	///
	bool lights_set = false;
	///
	bool lights_placed = false;
