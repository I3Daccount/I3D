...
public:
	...
	// support kit with custom context 
	bool get_world_location_ctx(context& ctx, int x, int y, const cgv::render::view& V, cgv::math::fvec<double, 3>& world_location, double* window_z_ptr = 0);
