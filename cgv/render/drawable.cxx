...
bool drawable::get_world_location_ctx(context& ctx, int x, int y, const cgv::render::view& V, cgv::math::fvec<double, 3>& world_location, double* window_z_ptr)
{
	// no context check here currently, TODO
	// analyze the mouse location
	//cgv::render::context& ctx = *get_context();
	const dmat4* DPV_ptr, * DPV_other_ptr;
	int x_other, y_other, vp_col_idx, vp_row_idx, vp_width, vp_height;
