...
rgbd_icp_tool::rgbd_icp_tool() {
	...
	icp_filter_type = ICP::RANDOM_SAMPLING;
}
...
void rgbd_icp_tool::create_gui()
{
	...
	add_member_control(this, "icp_samples", icp_samples, "value_slider", "min=400;max=40000;ticks=false");
	...
	add_member_control(this, "Sampling Type", (DummyEnum&)icp_filter_type, "dropdown", "enums='Precise Sampling,Radom Sampling,Full Matching,Normal-space Sampling'");
...
void rgbd_icp_tool::on_reg_ICP_cb()
{
	...
	point_cloud_types::Mat rotation; rotation.identity();
	point_cloud_types::Dir translation; translation.zeros();
